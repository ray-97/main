...
public class JsonAdaptedFoodTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedFood food =
                new JsonAdaptedFood(INVALID_NAME, VALID_CALORIE, VALID_PROTEIN, VALID_CARBOHYDRATE, VALID_FAT, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedFood food = new JsonAdaptedFood(null, VALID_CALORIE, VALID_PROTEIN, VALID_CARBOHYDRATE,  VALID_FAT, VALID_TAGS);
    ...
    public void toModelType_invalidCalorie_throwsIllegalValueException() {
        JsonAdaptedFood food =
                new JsonAdaptedFood(VALID_NAME, INVALID_CALORIE,  VALID_PROTEIN, VALID_CARBOHYDRATE, VALID_FAT, VALID_TAGS);
    ...
    public void toModelType_nullCalorie_throwsIllegalValueException() {
        JsonAdaptedFood food = new JsonAdaptedFood(VALID_NAME, null, VALID_PROTEIN, VALID_CARBOHYDRATE, VALID_FAT, VALID_TAGS);
    ...
    public void toModelType_invalidCarbohydrate_throwsIllegalValueException() {
        JsonAdaptedFood food =
                new JsonAdaptedFood(VALID_NAME, VALID_CALORIE, VALID_PROTEIN, INVALID_CARBOHYDRATE, VALID_FAT, VALID_TAGS);
    ...
    public void toModelType_nullCarbohydrate_throwsIllegalValueException() {
        JsonAdaptedFood food = new JsonAdaptedFood(VALID_NAME, VALID_CALORIE, VALID_PROTEIN,null,  VALID_FAT, VALID_TAGS);
    ...
    public void toModelType_invalidProtein_throwsIllegalValueException() {
        JsonAdaptedFood food =
                new JsonAdaptedFood(VALID_NAME, VALID_CALORIE, INVALID_PROTEIN, VALID_CARBOHYDRATE, VALID_FAT, VALID_TAGS);
    ...
    public void toModelType_nullProtein_throwsIllegalValueException() {
        JsonAdaptedFood food = new JsonAdaptedFood(VALID_NAME, VALID_CALORIE, null, VALID_CARBOHYDRATE, VALID_FAT, VALID_TAGS);
    ...
    public void toModelType_invalidFat_throwsIllegalValueException() {
        JsonAdaptedFood food =
                new JsonAdaptedFood(VALID_NAME, VALID_CALORIE, VALID_PROTEIN, VALID_CARBOHYDRATE, INVALID_FAT, VALID_TAGS);
    ...
    public void toModelType_nullFat_throwsIllegalValueException() {
        JsonAdaptedFood food = new JsonAdaptedFood(VALID_NAME, VALID_CALORIE, VALID_PROTEIN, VALID_CARBOHYDRATE, null, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedFood food =
                new JsonAdaptedFood(VALID_NAME, VALID_CALORIE, VALID_PROTEIN, VALID_CARBOHYDRATE, VALID_FAT, invalidTags);
