...
import static life.calgo.logic.commands.CommandTestUtil.*;
...
public class UpdateCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        CommandParserTestUtil.assertParseSuccess(parser, NAME_DESC_BANANA + CALORIE_DESC_BANANA + PROTEIN_DESC_BANANA + CARBOHYDRATE_DESC_APPLE
                + CARBOHYDRATE_DESC_BANANA + FAT_DESC_APPLE + FAT_DESC_BANANA + TAG_DESC_SOFT, new UpdateCommand(expectedFood));


        // multiple tags - all accepted
        Food expectedFoodMultipleTags = new FoodBuilder(TypicalFoodItems.BANANA).withTags(VALID_TAG_SOFT, VALID_TAG_HARD)
                .build();
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        CommandParserTestUtil.assertParseSuccess(parser, NAME_DESC_APPLE + CALORIE_DESC_APPLE + PROTEIN_DESC_APPLE + CARBOHYDRATE_DESC_APPLE + FAT_DESC_APPLE,
    ...
    public void parse_invalidValue_failure() {
        ...
        CommandParserTestUtil.assertParseFailure(parser, INVALID_NAME_DESC + CALORIE_DESC_BANANA + PROTEIN_DESC_BANANA + INVALID_CARBOHYDRATE_DESC + FAT_DESC_BANANA,
