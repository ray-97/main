...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        CommandParserTestUtil.assertParseFailure(parser, "1" + INVALID_PHONE_DESC, Calorie.MESSAGE_CONSTRAINTS); // invalid phone
        CommandParserTestUtil.assertParseFailure(parser, "1" + INVALID_EMAIL_DESC, Fat.MESSAGE_CONSTRAINTS); // invalid email
        CommandParserTestUtil.assertParseFailure(parser, "1" + INVALID_ADDRESS_DESC, Protein.MESSAGE_CONSTRAINTS); // invalid address
        CommandParserTestUtil.assertParseFailure(parser, "1" + INVALID_TAG_DESC, Tag.MESSAGE_CONSTRAINTS); // invalid tag

        // invalid phone followed by valid email
        CommandParserTestUtil.assertParseFailure(parser, "1" + INVALID_PHONE_DESC + EMAIL_DESC_AMY, Calorie.MESSAGE_CONSTRAINTS);

        // valid phone followed by invalid phone. The test case for invalid phone followed by valid phone
        // is tested at {@code parse_invalidValueFollowedByValidValue_success()}
        CommandParserTestUtil.assertParseFailure(parser, "1" + PHONE_DESC_BOB + INVALID_PHONE_DESC, Calorie.MESSAGE_CONSTRAINTS);
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditCommand.EditFoodDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        EditCommand.EditFoodDescriptor descriptor = new EditPersonDescriptorBuilder().withPhone(VALID_PHONE_BOB)
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        EditCommand.EditFoodDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
        CommandParserTestUtil.assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        EditFoodDescriptor descriptor = new EditPersonDescriptorBuilder().withPhone(VALID_PHONE_BOB).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
        CommandParserTestUtil.assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_resetTags_success() {
        ...
        EditCommand.EditFoodDescriptor descriptor = new EditPersonDescriptorBuilder().withTags().build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
