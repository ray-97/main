...
import f11_1.calgo.storage.FoodRecordStorage;
import f11_1.calgo.storage.JsonFoodRecordStorage;
import f11_1.calgo.storage.JsonUserPrefsStorage;
import f11_1.calgo.storage.Storage;
import f11_1.calgo.storage.StorageManager;
import f11_1.calgo.storage.UserPrefsStorage;
import f11_1.calgo.ui.Ui;
import f11_1.calgo.ui.UiManager;
...
public class MainApp extends Application {
    ...
    private Model initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
        Optional<ReadOnlyFoodRecord> addressBookOptional;
        ReadOnlyFoodRecord initialData;
        try {
            addressBookOptional = storage.readFoodRecord();
