...
This feature allows you to add a food preset with all its nutritional details into the Food Record.
This makes it more convenient for you to keep track of your food consumed in the day without having to manually key in the nutritional details everytime you do so.
...
Aspect: Updating the Food Record when there is an existing Food item in `FoodRecord`
...
** Cons:
This might not be intuitive for the user since update is generally assumed to be for editing something only, and not necessarily adding something.
