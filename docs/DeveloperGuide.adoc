...
* incomplete inputs can still give valid entries
...
[discrete]
=== Use case: deletes an existing Food Item in current Food record
...
[discrete]
=== Use case: generates a report on a specific day.
