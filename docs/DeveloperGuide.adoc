...
* <<Design-Model,*`Model`*>>: The in-memory data that is generated during usage of the App.
* <<Design-Storage,*`Storage`*>>: The manager of the App data that is stored in the hard disk.
...
* enjoys eating food
* wants to have, or already has healthy eating habits
* has a need to manage a significant number of Food items (finding nutritional information about each Food item or
tracking consumption patterns)
* prefers desktop apps over other types
* can type fast
* prefers typing over mouse input
* is reasonably comfortable using Command Line Interface apps

*Value proposition*:

* Health:
** get personalised recommendations of Food to eat that helps user achieve daily caloric goal
* Convenience:
...
* Self-awareness: generate personal consumption reports and view progress and statistics
...
(For all use cases below, the *System* is the `Calgo` application and the *Actor* is the `user`,
unless specified otherwise)

(The term *MSS* refers to Main Success Scenario)
[discrete]
...
[discrete]
=== Use case: set a daily dietary goal.

*MSS*

1.  User sets a dietary goal for the daily number of calories to be consumed.
2.  Calgo stores this goal in `goal.json`.
3. Calgo uses daily dietary goal to show number of remaining calories for the current day.
+
Use case ends.
