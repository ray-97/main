...
The following sequence diagram shows how the nom command works:

image::NomSequenceDiagram.png[]

The following activity diagram shows what happens when the user executes a Nom command.
...
** Cons: Violates layers of abstraction set in place by previous structure of AddressBook 3. Violates Single Responsibility Principle and reduce
cohesiveness of code.

===== Aspect: Aspect: Data structure to support the consumption commands
