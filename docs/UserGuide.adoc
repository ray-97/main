...
* Calgo automatically formats name inputs to title case. Therefore it does not matter whether you input a name in
upper or lower case.
...
Calgo automatically formats the name of your `Food` for you to title case. Hence, you
