...
.2+|Navigate Food Record|Find|Searches for and displays a particular `Food`.|`find [n/NAME] [cal/CALORIES] [p/PROTEINS] [c/CARBOHYDRATES] [f/FATS] [t/TAG]` (choose only 1 parameter)|`find n/Pizza`*OR*`find cal/110` etc
