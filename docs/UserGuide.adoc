...
// mentioned sentence case and insensitvity

Format: `update n/NAME cal/CALORIES p/PROTEINS c/CARBOHYDRATES f/FATS [t/TAGS]`

Examples:

* Suppose you often eat Mee Goreng but see that your Food Record does not have a record for this `Food`. After searching online, you can
update a new Food item of Mee Goreng, along with its nutritional values into Calgo.
