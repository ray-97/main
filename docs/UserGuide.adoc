...
* **`update**`n/kiwi cal/125 p/1 c/20 f/3` : adds `kiwi` to the Food Records if there is currently no Food called 'kiwi' inside it, with 'kiwi's details saved as: 125 calories, 1 gram of protein, 20 grams of carbohydrates, and 3 grams of fats.
