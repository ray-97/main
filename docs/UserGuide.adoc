...
image::GoalCommandBefore.png[width=]

Type in `goal 1900` and press kbd:[enter], as shown above. +

image::GoalCommandAfter.png[width=]
...
image::ReportGoalInfo.png[width=]
...
image::ReportFoodwiseStatistics.png[width=]
...
image::ReportAggregateStatistics.png[width=]
...
image::ReportInsights.png[width=]
...
image::ReportSuggestions.png[width=]
